...
def main():
    ...
    parser.add_argument(
        "--model_name_or_path",
        default=os.path.join(project_path, "pretrain_model"),
        type=str,
        required=False,
    ...
    parser.add_argument(
        "--output_dir",
        default=os.path.join(project_path, "outputs"),
        type=str,
        required=False,
    ...
    parser.add_argument(
        "--data_dir",
        default=os.path.join(project_path, "main/datasets"),
        type=str,
    ...
    parser.add_argument(
        "--feature_dir",
        default=os.path.join(project_path, "main/cache"),
        type=str,
    ...
    parser.add_argument(
        "--config_name", default=os.path.join(project_path, "pretrain_model/config.json"), type=str,
        help="Pretrained config name or path if not the same as model_name"
    )
    parser.add_argument(
        "--tokenizer_name",
        default=os.path.join(project_path, "pretrain_model/vocab.txt"),
        type=str,
        help="Pretrained tokenizer name or path if not the same as model_name",
    )
    parser.add_argument(
        "--cache_dir",
        default=os.path.join(project_path, "cache"),
        type=str,
    ...
    parser.add_argument("--do_merge", default=False, action="store_true", help="Whether to merge test prob.")
    parser.add_argument(
        "--evaluate_during_training", default=True, action="store_true",
