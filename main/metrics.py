...
def baidu_evaluate(ref_file, pred_file, verbose=False):
    ref_ans = json.load(io.open(ref_file,encoding="utf-8"))
    pred_ans = json.load(io.open(pred_file,encoding="utf-8"))
...
def compute_predictions_logits(
    ...
    # if not os.path.exists(str(output_prediction_file).split("\\")):
    #     os.makedirs(output_prediction_file)
    # if not os.path.exists(output_nbest_file):
    #     os.makedirs(output_nbest_file)
